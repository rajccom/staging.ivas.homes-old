  ...
  var lastId = $('.loader').attr('id');
    ...
    function filter_data(lastId)
    {
        ...
        $.ajax({
            ...
            method:"POST",
            data:{action:action, categroy:categroy, last_id:lastId, colour:colour, colour_one:colour_one, colour_two:colour_two, colour_three:colour_three, colour_four:colour_four, colour_five:colour_five, colour_six:colour_six, type:type, cock_type:cock_type, finish:finish, finish_one:finish_one, finish_two:finish_two, finish_three:finish_three, finish_four:finish_four, finish_five:finish_five, finish_six:finish_six, finish_seven:finish_seven, finish_eight:finish_eight, finish_nine:finish_nine, finish_ten:finish_ten, finish_eleven:finish_eleven, finish_twelve:finish_twelve, finish_thirteen:finish_thirteen, finish_fourteen:finish_fourteen, finish_fifteen:finish_fifteen, finish_sixteen:finish_sixteen, finish_seventeen:finish_seventeen, finish_eighteen:finish_eighteen, base_material:base_material, base_material_one:base_material_one, base_material_two:base_material_two},
            beforeSend:function(){
              $('.loader').show();
          },

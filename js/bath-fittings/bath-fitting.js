  ...
  var lastId = $('.loader').attr('id');
    ...
    function filter_data(lastId)
    {
        ...
        $.ajax({
            ...
            method:"POST",
            data:{action:action, category:category, last_id:lastId, colour:colour, colour_one:colour_one, colour_two:colour_two, colour_three:colour_three, colour_four:colour_four, colour_five:colour_five, colour_six:colour_six, colour_seven:colour_seven, colour_eight:colour_eight, colour_nine:colour_nine, colour_ten:colour_ten, colour_eleven:colour_eleven, colour_twelve:colour_twelve, colour_thirteen:colour_thirteen, type:type, cock_type:cock_type, finish:finish, finish_one:finish_one, finish_two:finish_two, finish_three:finish_three, finish_four:finish_four, finish_five:finish_five, collection:collection},
            beforeSend:function(){
              $('.loader').show();
          },
    ...
    var buttons = "<div align='center' class='next-preview-btn'><button type='button' name='previous' class='btn previous' id='"+p_product_id+"' "+disablePrev+" ><i class='fa fa-angle-left' aria-hidden='true'></i></button><button type='button' name='next' class='btn next' id='"+n_product_id+"' "+disableNext+"><i class='fa fa-angle-right' aria-hidden='true'></i></button></div>";
      $.ajax({
         ...
         if (api_data.colour || api_data.colour_one || api_data.colour_two || api_data.colour_three || api_data.colour_four || api_data.colour_five) {
           ...
           {
           markUp += ", " + api_data.colour_seven;
           }
           if (api_data.colour_eight)
           {
           markUp += ", " + api_data.colour_eight;
           }
           if (api_data.colour_nine)
           {
           markUp += ", " + api_data.colour_nine;
           }
           if (api_data.colour_ten)
           {
           markUp += ", " + api_data.colour_ten;
           }
           if (api_data.colour_eleven)
           {
           markUp += ", " + api_data.colour_eleven;
           }
           if (api_data.colour_twelve)
           {
           markUp += ", " + api_data.colour_twelve;
           }
           if (api_data.colour_thirteen)
           {
           markUp += ", " + api_data.colour_thirteen;
           }
           markUp += "</td></tr>";
         }
         if (api_data.packing) {
